  ...
  <!-- content -->
	<div id="content">
		<div class="content_first_title">
			<div class="content_first_title_t1">등록확인</div>
			...
			<table class="type10">
				<thead>
					<tr>
						...
						<th scope="cols" align="center" class="ca1">아이디</th>
...
<%
    ...
    try {
        ...
        String sql = "SELECT seller_id, buyer_id, startTime, payment_time, duration, nickname, status, address_id FROM payment_status WHERE seller_id = ?";
        ...
        while (rs.next()) {
            ...
            if (currenttime.compareTo(startTime) >= 0 && currenttime.compareTo(newTime) <= 0) {
            	...
            	// 사용중
                String updateSql = "UPDATE payment_status SET status = '이용중' WHERE seller_id = ? AND status = '결제완료'";
                pstmt = conn.prepareStatement(updateSql);
                pstmt.setString(1, user_id);
                pstmt.executeUpdate();
            } else if (currenttime.compareTo(newTime) > 0) {
                // 사용완료
                String updateSql = "UPDATE payment_status SET status = '이용완료' WHERE seller_id = ? AND status = '이용중'";
                pstmt = conn.prepareStatement(updateSql);
                pstmt.setString(1, user_id);
                pstmt.executeUpdate();
            }
            ...
            <tr>
            	...
            	<td class="even" align="center"><%= seller_id %></td>
...
%>
			...
			<input type = "button" class="btn1" value = "확인완료">
			<input type = "button" class="btn2" value = "시간초과">

...
<form id="addressForm" action="save_address.jsp" method="POST">
	<input type="text" id="addressInput" name="address" placeholder="주소를 입력하세요">
...
document.getElementById('addressForm').addEventListener('submit', function(event) {
    ...
    xhr.send('address=' + encodeURIComponent(address) + '&longitude=' + longitude + '&latitude=' + latitude);
});
